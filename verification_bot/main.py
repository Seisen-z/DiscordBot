...
def get_guild_verification_config(guild_id: str | int) -> dict:
    ...
    # 1. Try parent repo database or local folder database
    parent_db = BASE_DIR.parent / "database" / "onboarding_configs.json"
    target_db = ONBOARDING_FILE if ONBOARDING_FILE.exists() else parent_db
