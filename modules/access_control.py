...
OWNER_LOCKED_COMMANDS = {
    ...
    "level rank", "level leaderboard", "level tiers",
    "antispam status", "antispam enable", "antispam disable", "antispam configure",
    "antispam exempt_role", "antispam exempt_channel", "antispam log_channel",
    "apppanel setup", "apppanel delete", "application",
    "automod_status", "automod_hash",
    "bot_profile name", "bot_profile avatar", "bot_profile description", "bot_profile reset",
    "clear", "kick", "ban", "unban", "banlist", "baninfo", "purge", "report-fixed",
    ...
    "keypanel setup", "keypanel list", "keypanel delete",
    "import", "macroimport status", "macroimport toggle", "macroimport add-channel", "macroimport remove-channel",
    "membercounter create", "membercounter configure", "membercounter remove", "membercounter status",
    "membercounter set", "membercounter sync", "membercounter disable",
    "generatekeypremium", "generatekeyregular",
    "play", "pause", "resume", "skip", "stop", "queue", "nowplaying", "volume", "loop", "removequeue", "disconnect",
    "reaction_roles create", "reaction_roles add_role", "reaction_roles remove_role", "reaction_roles list", "select_roles create",
    "8ball", "coinflip", "dice", "joke", "meme", "quote", "roast", "compliment", "fact", "riddle", "check",
    "help", "ping", "hello", "say", "roll", "userinfo", "serverinfo", "avatar", "sync",
}
